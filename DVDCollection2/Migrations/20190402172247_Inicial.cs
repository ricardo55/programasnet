        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorFullName = table.Column<string>(maxLength: 60, nullable: false),
                    ActorNotes = table.Column<string>(maxLength: 300, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CertificateID = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    CertificateName = table.Column<string>(maxLength: 10, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ProducerID = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ProducerName = table.Column<string>(maxLength: 60, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FilmStory = table.Column<string>(maxLength: 300, nullable: false),
                    FilmReleaseDate = table.Column<DateTime>(nullable: false),
                    FilmDuration = table.Column<int>(nullable: false),
                    FilmAdditionalInfo = table.Column<string>(maxLength: 300, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActorID = table.Column<int>(nullable: false),
                    RoleID = table.Column<int>(nullable: false),
                    CharacterName = table.Column<string>(maxLength: 60, nullable: false),
                    CharacterDesc = table.Column<string>(maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
