...
namespace ReservacionHotelExamen2.Controllers
{
    public class BookingRoomController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["GuestID"] = new SelectList(_context.Guest, "GuestID", "GuestAdressCounty");
            ViewData["RoomID"] = new SelectList(_context.Room, "RoomID", "Floor");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("BookingID,RoomID,GuestID")] BookingRoom bookingRoom)
        {
            ...
            ViewData["GuestID"] = new SelectList(_context.Guest, "GuestID", "GuestAdressCounty", bookingRoom.GuestID);
            ViewData["RoomID"] = new SelectList(_context.Room, "RoomID", "Floor", bookingRoom.RoomID);
            return View(bookingRoom);
        }
