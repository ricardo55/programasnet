...
namespace ReservacionHotelExamen2.Controllers
{
    public class PaymentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentID,BookingID,CustomerID,PaymentMethodID,PaymentAmount,PaymentComments")] Payment payment)
        {
            ...
            ViewData["CustomerID"] = new SelectList(_context.Customer, "CustomerID", "CustomerAdressCountry", payment.CustomerID);
            ViewData["PaymentMethodID"] = new SelectList(_context.PaymentMethod, "PaymentMethodID", "PaymentMethodID", payment.PaymentMethodID);
            return View(payment);
        }
