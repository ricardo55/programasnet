        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerForenames = table.Column<string>(nullable: true),
                    CustomerSurnames = table.Column<string>(nullable: true),
                    CustomerDOB = table.Column<DateTime>(nullable: false),
                    CustomerAdressStreet = table.Column<string>(nullable: true),
                    CustomerAdressTown = table.Column<string>(nullable: true),
                    CustomerAdressCountry = table.Column<string>(nullable: true),
                    CustomerAdressPostalCode = table.Column<string>(nullable: true),
                    CustomerHomePhone = table.Column<string>(nullable: true),
                    CustomerWorkPhone = table.Column<string>(nullable: true),
                    CustomerMobilePhone = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FacilitieListID = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    FacilityDesc = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GuestForenames = table.Column<string>(nullable: true),
                    GuestSurnames = table.Column<string>(nullable: true),
                    GuestDOB = table.Column<DateTime>(nullable: false),
                    GuestAdressStreet = table.Column<string>(nullable: true),
                    GuestAdressTown = table.Column<string>(nullable: true),
                    GuestAdressCounty = table.Column<string>(nullable: true),
                    GuestAdressPostalCode = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PaymentMethodID = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    PaymentMethodDesc = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacilitieListID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
