...
namespace ReservacionHotelExamen2.Controllers
{
    public class RoomController : Controller
    {
        ...
        {
            ViewData["RoomBandID"] = new SelectList(_context.RoomBand, "RoomBandID", "BandDesc");
            ViewData["RoomPriceID"] = new SelectList(_context.RoomPrice, "RoomPriceID", "RoomPriceAmount");
            ViewData["RoomTypeID"] = new SelectList(_context.RoomType, "RoomTypeID", "RoomTypeDesc");
            return View();
        }
