...
namespace ReservacionHotelExamen2.Models
{
    public class Booking
    {
        ...
        [Display(Name="Fecha de Prestamo",Prompt="05/29/2019")]
        [DataType(DataType.Date)]
        [DisplayFormat(DataFormatString = "{0:MM/dd/yyyy}", ApplyFormatInEditMode = true)]
        public DateTime DateBookingMade { get; set; }

        [Display(Name = "Tiempo de Prestamo",Prompt="18:00:00")]
        ...
        [Display(Name="Fecha Inicio Prestamo",Prompt="05/29/2019")]
        [DataType(DataType.Date)]
        [DisplayFormat(DataFormatString = "{0:MM/dd/yyyy}", ApplyFormatInEditMode = true)] 
        public DateTime BookedStartDate { get; set; }

        [Display(Name="Fecha Final Prestamo",Prompt="05/29/2019")]
        [DataType(DataType.Date)]
        [DisplayFormat(DataFormatString = "{0:MM/dd/yyyy}", ApplyFormatInEditMode = true)] 
        public DateTime BookedEndDate { get; set; }


        [Display(Name="Fecha del Pago",Prompt="05/29/2019")]
        [DataType(DataType.Date)]
        [DisplayFormat(DataFormatString = "{0:MM/dd/yyyy}", ApplyFormatInEditMode = true)] 
        public DateTime TotalPaymentDueDate { get; set; }

        [Display(Name="Cantidad Total Pago",Prompt="1000")]
        ...
        [Display(Name="Fecha Total del Pago",Prompt="05/29/2019")]
        [DataType(DataType.Date)]
        //[DisplayFormat(DataFormatString = "{0:MM/dd/yyyy}", ApplyFormatInEditMode = true)] 
