...
namespace Universidad.Controllers
{
    public class EstudianteControlador : Controller
    {
        ...
        public EstudianteControlador(UniversidadContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,LastName,FirstMidName,SecondMidName,FechaInscripcion")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,LastName,FirstMidName,SecondMidName,FechaInscripcion")] Student student)
        {
            if (id != student.ID)
            {
                return NotFound();
